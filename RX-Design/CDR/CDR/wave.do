...
add wave -noupdate -format Analog-Step -height 100 -max 1023.0 -min -1024.0 /CDR_Tb/Dut/DLF/code
add wave -noupdate /CDR_Tb/Dut/DLF/phase_integrator
add wave -noupdate -color Magenta -format Analog-Step -height 74 -max 1000000.0000000001 /CDR_Tb/Dut/DLF/freq_integrator
...
add wave -noupdate /CDR_Tb/Dut/phase_interpolator/RESULT_PERIOD
...
WaveRestoreCursors {{Cursor 1} {254442002 fs} 1} {{Cursor 2} {98691872 fs} 1} {{Cursor 3} {147738709862 fs} 0}
...
update
WaveRestoreZoom {147738664294 fs} {147738755430 fs}
