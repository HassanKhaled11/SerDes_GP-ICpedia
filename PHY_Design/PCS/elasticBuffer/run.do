vlib work
vlog binToGray.v binToGrayTB.v memory.v read_pointer_control.v synchronous_unit.v write_pointer_control_unit.v elasticBuffer.v elasticBuffer_tb.sv thresholdMonitor.v
...
add wave -position insertpoint  \
sim:/elasticBuffer_tb/DUT/Threshold_Monitor_Inst/BUFFER_DEPTH \
sim:/elasticBuffer_tb/DUT/Threshold_Monitor_Inst/max_buffer_addr \
